...
# cs100-F2018-lab2-starter

Designed for use with [GitHub Classroom](https://classroom.github.com/), this
repository contains the starter for Laboratory 2 in Computer Science 100. Since
...
Available for from the course web site, the carefully formatted assignment sheet
for this project provides more details about the steps that a computer scientist
should take to complete this assignment. You can also view this same
assignment sheet by visiting the listing of laboratories on the course web
site.
...
```
Gregory M. Kapfhammer Tue Sep 11 11:18:44 EDT 2018
...
- labtwo/ComputeMoonDistance.java:
  ...
  - Performs a mathematical computation yielding the number `420384800`
...
```
git remote add download git@github.com:Allegheny-Computer-Science-100-F2018/cs100-F2018-lab2-starter.git
```
...
Starter](https://github.com/Allegheny-Computer-Science-100-F2018/cs100-F2018-lab2-starter)
